import { curry, uniq, isNil } from 'ramda';
...
export const normalizeLanguageString = (
  ...
  if (!string) { return defaults; }
  const [language, country] = string.toLowerCase().split('_');
 ...
 */
export const replaceStringVars = curry((replace, string) => (
